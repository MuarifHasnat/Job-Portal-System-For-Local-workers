...
// Verify booking belongs to this customer and is 'done'
$sql = "SELECT id, user_id, status FROM bookings WHERE id = ? LIMIT 1";
...
header('Location: /jobportalsystem/bookings/my_bookings.php?completed=1');
exit;
